...
Dialogue classroom_dialogue[] = {
    {0, 1, -1, "我：最近在資工系感覺課業繁重啊... "},
    {1, 1, -1, "我：還好系上的泡麵頭教授人很好,下一節他的課我也要好好努力www"},
    {2, 1, -1, "而且最令人期待的是等等會跟女神一起上課 (owo)"},
    {3, 1, -1, "不知道今天有沒有機會跟她說到話呢～（歪頭燦笑）"},
    {4, 1, -1, "我：（鐘響）啊啊要趕快去下一堂課了，不然搶不到好位子，先不說了..."},
    {5, 1, 0, "不知名宅宅：同...同學，你好可愛喔，跟我交往好嗎www？（後空翻"},
    {6, 2, 0, "1)doki doki doki doki doki doki <3\n2)不...不好意思，請問你是？"},
    {7, 1, 1, "教授：以上是今天的教學內容，這裡有一個題目，\n(玩家姓名)同學願意試試看嗎？"},
    {8, 2, -1, "1)好\n2)先pass\n3)恩...先思考一下"},
    ...
    {11, 1, 2, "校花：不好意思，剛剛老師教的我不太懂，可以教我一下嗎？"},
    {12, 1, -1, "我：（女神居然主動找我！！我要好好表現！！）"},
    {13, 1, -1, "我：哪一題有問題呢？我可以試試看wwwwww"},
    {14, 1, 2, "校花：你看這題...."},
    {15, 1, 2, "校花：對了，請問你是什麼學校的呢？"},
};
